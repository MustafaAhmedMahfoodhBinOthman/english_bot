...
#     if context.user_data.get('mode') == 'dictionary':
#         await update.message.reply_text("Exiting Dictionary mode.")
#     context.user_data.clear()
#     await send_main_menu(update, context)
...
#     if query.data.startswith('spelling_'):
#         difficulty = query.data.split('_')[1]
#         if difficulty == 'stop':
#             await stop_command(update, context)
#         else:
...
#     # Convert word to audio and send
